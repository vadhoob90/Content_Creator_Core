...
DOCUMENTED_COMMANDS = [
    ...
    ["setup", "provider", "codex-native"],
    ["setup", "provider", "openai", "--confirm-api-billing"],
    ["overview"],
    ["overview", "--json"],
    ["personalisation", "show"],
    ["personalisation", "explain", "--role", "writer"],
    ["context", "show", "run-id"],
    ["start"],
    ...
    ["voice", "status", "example-person", "--human"],
